          ...
          on_punch = function(self, hitter)
             ...
             if self.object:get_hp() <= 0 then
				...
				--here is where things are broke
                                ...
                                --meta:set_string("infotext", self.full_name.."'s fresh bones")  --lua:570: attempt to concatenate field 'full_name' (a nil value)
                                meta:set_string("infotext", self.name.."'s fresh bones")  --lua:570: attempt to concatenate field 'full_name' (a nil value)
                                meta:set_string("owner", "Monster ")
